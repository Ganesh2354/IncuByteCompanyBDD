Feature: Compose a new email
  ...
  Scenario: Verify the ability to compose a new email in Gmail.
    ...
    And I choose to Verify that the compose window contains the necessary fields like To, Cc, Bcc, Subject, and Message Body
    #Error Handling#
    ...
    # Try to send an email without entering a message body.
